...
df_base = pd.read_csv('model_logs/v17.1.base.csv')
df_batch = pd.read_csv('model_logs/v17.1.batch128.csv')
#df_super = pd.read_csv('model_logs/v17.1.super.csv')
#df_reward = pd.read_csv('model_logs/v17.1.reward.csv')
